	...
	handleSubmit(evt) {
		...
		if (file !== '' && chars_left >= 0) {
			...
			uploadTask.on('state_changed', (snapshot) => {}, (error) => {
				...
				updates['/userTL/' + userId + '/' + newScribeReplyImgKey] = userTLData;
			...
			<form onSubmit={this.handleSubmit.bind(this)}>
				<article className="media nested-flat-box">
					...
					<div className="media-right">
						<a onClick={this.handleReplyCancel.bind(this)} className="remove" data-balloon="cancel" data-balloon-pos="up">
							<span className="icon is-small">
								<i className="fa fa-times" aria-hidden="true"></i>
							</span>
						</a>
